...
def get_building_record_wikidata(wikidata) -> dict:
...
def make_image_desc(filename, wikidata, place_en, place_ru) -> str:
    ...
    building_record = get_building_record_wikidata(wikidata)
...
def get_heritage_id(wikidata) -> str:
...
def append_image_descripts_claim(commonsfilename, entity_list):
...
# append_image_descripts_claim("Chekhov_railway_20230409_032.tif", ["Q4448929","Q34336"])

make_image_desc("imgs/_20170528_00230.JPG", "Q117713286")
